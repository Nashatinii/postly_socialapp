...
export default function Topbar({ setSearchTerm }) {
    ...
    return (
        <div className="topbarContainer">
            ...
            {currentUser && currentUser.username && currentUser.username.toLowerCase() === "adminadmin" && (
                <Button component={Link} to="/Home/AdminDashboard" color="inherit">ADMIN</Button>
            )}
            ...
            <div className="topbarRight">
                ...
                <li className="sidebarListItem">
                    ...
                    <span className="sidebarListItemText" onClick={handleLogout}>Log out</span>
                </li>
            </div>
        </div>
    );
